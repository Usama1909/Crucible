...
# Test 1 — cold start, no proven agents
...
# Test 2 — proven + exploring, no degraded
...
# Test 3 — proven + degraded + exploring all present
...
# Test 4 — correlated agents share one slot
...
check("correlated total = 0.90 (explorer takes 0.10)", abs(result[7] + result[8] - 0.90) < 0.001)

# Test 5 — higher edge gets more budget
